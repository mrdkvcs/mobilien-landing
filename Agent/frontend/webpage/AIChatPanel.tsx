...
export default function AIChatPanel() {
  return (
    <div className="relative w-full overflow-hidden min-h-[500px]">
      ...
      {/* Flowing shapes */}
      <div
        className="absolute -top-48 -left-48 w-[800px] h-[800px] z-0 animate-flow"
        style={{
      ...
      />
      <div
        className="absolute -bottom-36 -right-36 w-[600px] h-[600px] z-0 animate-flow-reverse"
        style={{
      ...
      {/* Accent dots */}
      <div
        className="absolute top-[20%] right-[15%] w-[120px] h-[120px] rounded-full z-0 animate-float"
        style={{
          background:
      ...
      />
      <div
        className="absolute bottom-[30%] left-[20%] w-[80px] h-[80px] rounded-full z-0"
        style={{
          background:
      ...
      {/* Shimmer line */}
      <div className="absolute top-[10%] left-[10%] right-[10%] h-[2px] z-0 animate-shimmer"
        style={{
          background:
      ...
      <div className="relative py-[55px] md:py-[80px] z-10">
