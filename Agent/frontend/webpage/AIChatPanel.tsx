...
export default function AIChatPanel() {
  return (
    <div className="relative w-full overflow-hidden min-h-[500px]" style={{ position: 'relative', zIndex: 0 }}>
      ...
      <div className="relative py-[55px] md:py-[80px]" style={{ zIndex: 10, position: 'relative' }}>
